...
public class CtrlProduct {
	...
	// Metodo para obtener un listado de productos segun la categoria
	
	@GetMapping("/category/{category_id}")
	public ResponseEntity<List<ProductDTO>> listProducts(@PathVariable("category_id") int category_id){
